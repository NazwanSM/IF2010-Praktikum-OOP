...
public class mpv {
    ...
    public static class Video {
        ...
        public void addSubtitle(String language) throws InvalidSubtitleException, DuplicateSubtitleException {
            Subtitle subtitle = new Subtitle(language);
        ...
        public boolean hasSubtitle(String language) {
            ...
            for (Subtitle subtitle : subtitles) {
                if (subtitle.getLanguage().equalsIgnoreCase(language)) {
                    return true;
                }
            }
            return false;
        ...
        public List<String> getAvailableLanguages() {
            ...
            for (Subtitle subtitle : subtitles){
                avaList.add(subtitle.getLanguage());
            }
     ...
     * tidak sesuai.
     */
    static class InvalidVideoFormatException extends Exception {
     ...
     * database.
     */
    static class VideoNotFoundException extends Exception {
     ...
     * yang sudah ada.
     */
    static class DuplicateVideoException extends Exception {
     ...
     * null).
     */
    static class InvalidSubtitleException extends Exception {
     ...
     * yang sudah ada.
     */
    static class DuplicateSubtitleException extends Exception {
    ...
    public void addVideo(String title, String filename, int durationSeconds) throws InvalidVideoFormatException, DuplicateVideoException {
        ...
        for (Video video : videoDatabase.values()) {
            if (video.getFilename().equalsIgnoreCase(filename)) {
    ...
    public List<Video> getVideosByFormat(String format) {
        ...
        for (Video video : videoDatabase.values()) {
            if (video.getFilename().toLowerCase().endsWith("." + formatLower)) {
                result.add(video);
            }
        }
